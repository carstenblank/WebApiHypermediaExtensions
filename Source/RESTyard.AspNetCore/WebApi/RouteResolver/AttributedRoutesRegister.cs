            ...
            foreach (var method in assemblyMethods)
            {
                ...
                switch (hypermediaAttribute)
                {
                    ...
                    case HttpPutHypermediaAction httpPutHypermediaAction:
                        this.AddActionRoute(httpPutHypermediaAction.RouteType, httpPutHypermediaAction.Name, HttpMethod.POST, httpPutHypermediaAction.AcceptedMediaType, httpPutHypermediaAction.IsExternalResource);
